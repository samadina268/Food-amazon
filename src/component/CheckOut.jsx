            ...
            <div className="col-12 col-md-6">
              ...
              <div>
                <div>
                  ...
                  <label htmlFor="residence" className="checkout-label d-block mt-3">Deliver to</label>
                  <select id="residence" className="w-100 d-block checkout-selectOpt mt-2 rounded-2 ">
                  ...
                  <label className="checkout-label d-block mt-3" htmlFor="country">Country</label>
                  <select id="country" className="w-100 d-block checkout-selectOpt mt-2 rounded-2 ">
                  ...
                  <div className="row mt-3">
                    ...
                    <div className="col-4">
                      <select id="country" className="w-100  d-block checkout-selectOpt rounded-2 h-100">
                        <option>Ikeja</option>
                        <option>Ojudu</option>
                        <option>Ogba</option>
                  ...
                  <div>
                    <label htmlFor="text" className="d-block checkbox-label-note mt-3">
            ...
            <div className="col-12 col-md-6 mt-3 mt-md-0">
              <div>
                ...
                <div className="row justify-content-between checkOut-Order-price">
                  ...
                  <div className="col-2 justify-content-end d-flex">$582.00</div>
                </div>

                <div className="row justify-content-between checkOut-Order-saving mt-2">
                  <div className="col-5">Savings</div>
                  <div className="col-2  justify-content-end d-flex">$82.00</div>
                </div>
                ...
                <div className="row justify-content-between checkOut-order-total">
                  ...
                  <div className="col-2 d-flex justify-content-end">$496.50</div>
                </div>
              </div>
              ...
              <div>
               ...
               <div className="w-100">
                 <label htmlFor="card-radio" className=" justify-content-between w-100">

                  <div>
                    <input type="radio" name="payment" id="card-radio" required />
                  ...
                  <div className="row justify-content-between ms-3  ">
                    ...
                    <div className="col-4 d-flex justify-content-end h-100  ">
                      <img src={VisacardLogo} alt="visa card logo" loading="lazy" className="w-100" />
                    </div>
                  </div>
                  ...
                  <div className="mt-3 ">
                    <label htmlFor="card" className="">
                      <input type="checkbox" name="card" id="card" className="checkOut-card-remCard" />
                      <span className="ms-2">Remember this card for future order</span>
                    </label>
                  </div>

                  <div className="row mt-3">
                    <div className="col-6">
                      <button type="button" className="btn btn-success w-100" onClick={submitCard}>Done</button>
                    </div>
                    <div className="col-6">
                      <button type="reset" onClick={cancelCard} className="btn btn-outline-success w-100">
                        Cancel
                      </button>
                    </div>
                  </div>
                ...
                <div className="row justify-content-between mt-3">
                  <div className="col-3">
                    <label htmlFor="paypal-radio" className="d-flex align-items-center">
                  ...
                  <div className="col-3">
                    <div className="">
                      <img src={PaypalcardLogo} alt="paypal card logo" loading="lazy" className="w-100" />
                    </div>
                  </div>
                </div>

                <div className="mt-4 mb-5">
                  <button type="submit" className="w-100 checkOut-btn btn btn-success">
                    place Order
                  </button>
                </div>
              </div>
